...
const navigation = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Contract Reviewer", url: "/contract-review", icon: Scale },
      { title: "Content Generator", url: "/generator", icon: Sparkles },
  ...
  },
  {
    title: "Documents",
    items: [
      { title: "Smart Upload", url: "/documents", icon: FileText },
    ...
    >
      <SidebarHeader className="border-b border-border/50 p-4">
        <div className="flex items-center gap-2">
          ...
          {!collapsed && (
            <div>
              <h2 className="font-semibold text-foreground">Collabrium</h2>
